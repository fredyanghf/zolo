...
<div class="product_item_wrapper">
    ...
    <div class="product_color big_color">
        <span rel="images/power_1.jpg" class="hover"><em></em><i>1</i></span>
        <span class="pc_black" rel="images/power_2.jpg"><em></em><i>2</i></span>
        <span rel="images/power_3.jpg"><em class="pc_blue"></em><i>3</i></span>
        <span rel="images/power_4.jpg"><em class="pc_red"></em><i>4</i></span>
    </div>
    <!--end.product_color-->
    <div class="product_price">$<strong>15</strong></div>
    <a class="product_buy" href="" onclick="clickoutconv('bundle3', 15);return false;">CONTRIBUTE NOW</a> <span class="product_buy_info">Products not sold separately. </span>
</div>